...
passwords.forEach(rules => {
    let userPassword = rules.split(': ');
    let nums = userPassword[0].split(' ')[0].split('-');
    let firstLetterPosition = +nums[0] - 1;
    let secondLetterPosition = +nums[1] - 1;
    let letter = userPassword[0].split(' ')[1];
    if (userPassword[1][firstLetterPosition] == letter && userPassword[1][secondLetterPosition] !== letter ||
        userPassword[1][firstLetterPosition] !== letter && userPassword[1][secondLetterPosition] == letter) {
        countValidPasswords += 1;
    }
});

console.log('countValidPasswords ', countValidPasswords);